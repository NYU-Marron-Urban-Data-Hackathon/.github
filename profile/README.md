...
**Project submission deadline:** Monday, November 7, 2022, 11:59 PM EST
...
* Bartosz Bonczak [bartosz.bonczak@nyu.edu]
* Boyeong Hong [boyeong.hong@nyu.edu]
...
### [Civic Analytics](https://marroninstitute.nyu.edu/programs/civic-analytics)

**About:** The Civic Analytics program, led by Professor Constantine Kontokosta, works directly with cities to acquire, analyze, and derive insight from data in order to solve tangible and significant problems of city management, policy, and planning.

**Example Problems:**
- Identification and measurement of algorithmic and data bias in city management;
- Implementation of the evidence-based climate policies for sustainability and environmental justice goals;
...
### [Health, Environment, and Policy](https://marroninstitute.nyu.edu/programs/health-environment-and-policy)
**About** The Health, Environment, and Policy program, led by Professor Kevin Cromar, improves health through scientific research, direct policy engagement, and collaboration with agencies at the local, federal, and international level.

**Example Problems:**
- Health and Social Imapcts of Air Pollution
- Air Pollution Exposure assesment
- Science-based Air Quality Public Policy Recommendations
...
---
<!-- 
### [Litmus](https://marroninstitute.nyu.edu/programs/litmus)
**About** The Litmus program, led by Professor Angela Hawken, works with public agencies and the people they serve to develop and rigorously test new ideas for improving the performance of the public sector.

**Problem**

**Data**
- 311
- Buildinf Energy Data
...
### [Transportation and Land Use](https://marroninstitute.nyu.edu/programs/transportation-and-land-use)
**About** The Transportation and Land Use program, led by Professor Eric Goldwyn, examines transit-infrastructure projects, land-use policies, and complementary data sets to understand how public agencies build, manage, and pay for capital projects, like subway expansions, bicycle lanes, and high speed rail. 

**Example Problems:**
- What drives the transportation project cost on the local and regional level?
...
### [Urban Expansion](https://marroninstitute.nyu.edu/programs/urban-expansion)
**About** The Urban Expansion program, led by Professor Shlomo Angel and supported jointly with the NYU Stern Urbanization Project, works with rapidly growing cities to better prepare them for their inevitable growth.

**Example Problems:**
- Monitor global and national urban expansion levels
- Project scenarios of urban growth and study their possible effects on urban development, resilience and governance
...
* [Angel, S., & Blei, A. (2020). Why pandemics, such as COVID-19, require a metropolitan response. Sustainability, 13(1), 79.](https://www.mdpi.com/934300)

---

### [Co-City Baton Rouge](https://marroninstitute.nyu.edu/initiatives/co-city-baton-rouge)
**About** The Co-City Baton Rouge (CCBR) initiative, led by Clayton Gillette, supports collaborative and cooperative self-governing institutions through community engagement to revitalize the economy in the Plank Road Corridor of Baton Rouge. 

**Example Problems:**
- ***How to visualize the locational efficiency of landbank properties in the Plank Road Corridor of Baton Rouge, Louisiana?***
